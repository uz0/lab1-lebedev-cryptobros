...
},{"crypto":"../node_modules/parcel-bundler/src/builtins/_empty.js"}],"../node_modules/near-api-js/node_modules/borsh/node_modules/bn.js/lib/bn.js":[function(require,module,exports) {
...
},{"bn.js":"../node_modules/near-api-js/node_modules/borsh/node_modules/bn.js/lib/bn.js","bs58":"../node_modules/bs58/index.js","text-encoding-utf-8":"../node_modules/text-encoding-utf-8/lib/encoding.lib.js","buffer":"../node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/utils/serialize.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"bn.js":"../node_modules/near-api-js/node_modules/bn.js/lib/bn.js","depd":"../node_modules/depd/lib/browser/index.js","./transaction":"../node_modules/near-api-js/lib/transaction.js","./providers":"../node_modules/near-api-js/lib/providers/index.js","borsh":"../node_modules/near-api-js/node_modules/borsh/lib/index.js","./utils/key_pair":"../node_modules/near-api-js/lib/utils/key_pair.js","./utils/errors":"../node_modules/near-api-js/lib/utils/errors.js","./utils/rpc_errors":"../node_modules/near-api-js/lib/utils/rpc_errors.js","./constants":"../node_modules/near-api-js/lib/constants.js","./utils/exponential-backoff":"../node_modules/near-api-js/lib/utils/exponential-backoff.js","buffer":"../node_modules/buffer/index.js"}],"../node_modules/near-api-js/lib/account_multisig.js":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
'use strict';
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
...
var CONTRACT_NAME = "cryptobros.lebedev.testnet" || 'change_this_account';
/* TODO: Change this to the deployed account */
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/angly", "/.near/validator_key.json"),
...
},{}],"assets/js/near/utils.js":[function(require,module,exports) {
var define;
"use strict";
...
exports.addBro = addBro;
exports.getBros = getBros;
exports.initContract = initContract;
exports.login = login;
exports.logout = logout;
exports.removeBro = removeBro;
...
function getBros() {
  return _getBros.apply(this, arguments);
}

function _getBros() {
  _getBros = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var bros;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return window.contract.get_bros({
          ...
          case 2:
            bros = _context2.sent;
            return _context2.abrupt("return", bros);
...
function addBro(_x) {
  return _addBro.apply(this, arguments);
}

function _addBro() {
  _addBro = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(accountId) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return window.contract.add_bro({
              args: {
...
function removeBro(_x2) {
  return _removeBro.apply(this, arguments);
}

function _removeBro() {
  _removeBro = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(accountId) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return window.contract.remove_bro({
              args: {
                account_id: accountId
              }
            });
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"assets/js/near/config.js"}],"assets/js/main.js":[function(require,module,exports) {
"use strict";
...
function signedOutFlow() {
  ...
  document.querySelector('.sign-in .btn').onclick = _utils.login;
}
...
function fillBros() {
  return _fillBros.apply(this, arguments);
} // Displaying the signed in flow container and display counter


function _fillBros() {
  _fillBros = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var _document$querySelect, _document$querySelect2, _document$querySelect3;

    var allBros, following, followedBy, bros;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _utils.getBros)();

          case 2:
            allBros = _context3.sent;
            following = Object.entries(allBros).filter(function (_ref3) {
            ...
            followedBy = Object.entries(allBros).filter(function (_ref7) {
              var _ref8 = _slicedToArray(_ref7, 2),
                  bro = _ref8[0],
                  status = _ref8[1];

              return status === 'FollowedBy';
            }).map(function (_ref9) {
            ...
            bros = Object.entries(allBros).filter(function (_ref11) {
            ...
            document.querySelectorAll('.bro').forEach(function (bro) {
              return bro.remove();
            });

            (_document$querySelect = document.querySelector('.following')).append.apply(_document$querySelect, _toConsumableArray(following.map(function (bro) {
              return getBroButton("".concat(bro, " (click to unfollow)"), '', function () {
                return (0, _utils.removeBro)(bro);
              });
            })));

            (_document$querySelect2 = document.querySelector('.followedBy')).append.apply(_document$querySelect2, _toConsumableArray(followedBy.map(function (bro) {
              return getBroButton("".concat(bro, " (click to bro)"), '', function () {
                return (0, _utils.addBro)(bro);
              });
            })));

            (_document$querySelect3 = document.querySelector('.bros')).append.apply(_document$querySelect3, _toConsumableArray(bros.map(function (bro) {
              return getBroButton("".concat(bro, " \uD83D\uDE0E (click to unbro)"), '', function () {
                return (0, _utils.removeBro)(bro);
              });
            })));
...
function signedInFlow() {
  ...
  document.querySelector('.sign-out .btn').onclick = _utils.logout;
  document.querySelector('.header').textContent = "Cryptobros (feat. ".concat(window.accountId, " \uD83D\uDE0E)!");
  document.querySelector('.connections').style.display = 'flex';
  document.querySelector('.following button').onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _window$prompt;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            newBro = (_window$prompt = window.prompt('Enter name of a bro you want to add 😎:', '')) === null || _window$prompt === void 0 ? void 0 : _window$prompt.trim();
